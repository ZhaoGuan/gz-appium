...
class Ikey_Function:
    def __init__(self, tester, driver, device='none'):
        self.driver = driver
    ...
    def precast_condition(self, del_package, install_package_path, typewriting):
        ...
        # else:
        #     try:
        #         unin_result = os.popen('adb -s %s uninstall %s' % (self.device, del_package))
        #     except Exception as e:
        #         print(e)
        #         print('没有对应应用')
        # 安装应用
        # self.BF.adb_install(install_package_path, self.device)
        self.BF.keyboard_select(typewriting, self.device)
        self.BF.open_app_atcivity('com.emoji.ikeyboard/com.qisi.ikeyboarduirestruct.NavigationActivity')
        ...
        if theme == False:
            ...
            while True:
                ...
                if out == 6:
                    break
        # 点击设定
        self.BF.click('id', 'com.emoji.ikeyboard:id/item_settigns')
        # 点击语言
    ...
    def reach_language_add(self, language):
        ...
        v_y = self.BF.element_size('id', 'com.emoji.ikeyboard:id/root', "height")
        self.BF.reach_element_click(v_y * 5, 'name', language, fail_pic=False)
        language_no = self.BF.elements('id', 'com.emoji.ikeyboard:id/tv_name')
        for i in range(len(language_no)):
            find_l = self.BF.attribute_name('ides', 'com.emoji.ikeyboard:id/tv_name[%s]' % i, fail_pic=False)
            if find_l == language:
                print(find_l)
                self.BF.click('ides', 'com.emoji.ikeyboard:id/tv_add[%s]' % i)
    ...
    def app_theme(self):
        ...
        # keyboard.select_theme(1, 1)
        setting = self.BF.existence('name', 'Settings')
        if setting == False:
            count = 0
            while True:
                try:
                ...
                if count > 10:
                    break
            etting = self.BF.existence('name', 'Settings')
        theme = self.BF.click_change('name', 'Theme')
        self.BF.check_assertTrue(theme, '进入Theme页面失败')

    def app_settings(self):
        self.BF.open_app_atcivity('com.emoji.ikeyboard/com.qisi.ikeyboarduirestruct.NavigationActivity',
                                  self.device)
        settings = self.BF.click_change('id', 'com.emoji.ikeyboard:id/item_settigns')
    ...
    def old_new_app_theme(self, i, package, typewriting, old, new):
        if self.device == 'none':
            ...
            try:
                unin_result = os.popen('adb -s %s uninstall %s' % (self.device, package))
            except Exception as e:
                print(e)
                print('没有对应应用')
        # 安装老应用
    ...
    def custom_keyboard(self):
        ...
        theme_preview = self.BF.element_picture('id', 'com.emoji.ikeyboard:id/theme_preview')
        # 获取seekbar控件属性
        self.seekbar('id', 'com.emoji.ikeyboard:id/seek_bar_color_brightness', 1 / 2)
        theme_preview_change = self.BF.cintrast_element_picture('id',
                                                                'com.emoji.ikeyboard:id/seek_bar_color_brightness',
                                                                theme_preview)
        self.BF.check_assertFalse(theme_preview_change, 'Effect没有变化')
        # Button
        self.BF.click('name', 'Button')
        theme_preview_button = self.BF.element_picture('id', 'com.emoji.ikeyboard:id/theme_preview')
        self.BF.click_change('id', 'com.emoji.ikeyboard:id/button_2')
        theme_preview_button_change = self.BF.cintrast_element_picture('id',
                                                                       'com.emoji.ikeyboard:id/theme_preview',
                                                                       theme_preview_button)
        self.BF.check_assertFalse(theme_preview_button_change, 'button2修改无变化')
        self.BF.click_change('id', 'com.emoji.ikeyboard:id/button_1')
        ...
        theme_preview_button_seekbar = self.BF.element_picture('id', 'com.emoji.ikeyboard:id/theme_preview')
        self.seekbar('id', 'com.emoji.ikeyboard:id/seek_bar', 3 / 4)
        ...
        theme_preview_fount = self.BF.element_picture('id', 'com.emoji.ikeyboard:id/theme_preview')
        self.seekbar('id', 'com.emoji.ikeyboard:id/seek_bar', 1 / 3)
        ...
        theme_preview_fount1 = self.BF.element_picture('id', 'com.emoji.ikeyboard:id/theme_preview')
        self.BF.random_click('id', 'com.emoji.ikeyboard:id/button')
        ...
        # color 无法做
        self.BF.click('id', 'com.emoji.ikeyboard:id/save')
        while True:
            try:
                ...
                pass
        self.BF.click('id', 'com.emoji.ikeyboard:id/md_buttonDefaultPositive')
    ...
    def change_custom_keyboard(self):
        self.app_theme()
        self.BF.click('id', 'com.emoji.ikeyboard:id/fab')
        before_change = self.BF.element_picture('ides', 'com.emoji.ikeyboard:id/item[0]')
        self.BF.click('id', 'com.emoji.ikeyboard:id/edit')
        self.BF.click('id', 'com.emoji.ikeyboard:id/edit_button_action')
        # 选择背景
        background = self.BF.element_picture('id', 'com.emoji.ikeyboard:id/theme_preview')
        bg_count = 0
        while True:
            self.BF.random_click('xpath',
                                 '//android.support.v4.view.ViewPager/android.widget.FrameLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout[3]/android.widget.ImageButton')
            change_background = self.BF.cintrast_element_picture('id', 'com.emoji.ikeyboard:id/theme_preview',
                                                                 background)
        ...
        theme_preview = self.BF.element_picture('id', 'com.emoji.ikeyboard:id/theme_preview')
        # 获取seekbar控件属性
        self.seekbar('id', 'com.emoji.ikeyboard:id/seek_bar_color_brightness', 1 / 3)
        theme_preview_change = self.BF.cintrast_element_picture('id',
                                                                'com.emoji.ikeyboard:id/seek_bar_color_brightness',
                                                                theme_preview)
        self.BF.check_assertFalse(theme_preview_change, 'Effect没有变化')
        ...
        self.BF.check_assertFalse(theme_preview_button_change, 'button2修改无变化')
        theme_preview_button_seekbar = self.BF.element_picture('id', 'com.emoji.ikeyboard:id/theme_preview')
        self.seekbar('id', 'com.emoji.ikeyboard:id/seek_bar', 1 / 4)
        theme_preview_button_seekbar_change = self.BF.cintrast_element_picture('id',
                                                                               'com.emoji.ikeyboard:id/theme_preview',
                                                                               theme_preview_button_seekbar)
        self.BF.check_assertFalse(theme_preview_button_seekbar_change, 'button seek没有变化')
        ...
        self.BF.click('name', 'Font')
        theme_preview_fount = self.BF.element_picture('id', 'com.emoji.ikeyboard:id/theme_preview')
        self.seekbar('id', 'com.emoji.ikeyboard:id/seek_bar', 2 / 3)
        theme_preview_fount_change = self.BF.cintrast_element_picture('id',
                                                                      'com.emoji.ikeyboard:id/theme_preview',
                                                                      theme_preview_fount)
        self.BF.check_assertFalse(theme_preview_fount_change, '字体大小没有变化')
        ...
        self.driver.back()
        self.BF.click('id', 'com.emoji.ikeyboard:id/edit')
        after_change = self.BF.cintrast_element_picture('ides', 'com.emoji.ikeyboard:id/item[0]', before_change)
    ...
    def change_theme(self, i):
        ...
        if i > 7:
            ...
            if i == 8:
                ...
                i = 7
        self.BF.click('ides', 'com.emoji.ikeyboard:id/item[%s]' % i)
        self.driver.tap([(200, 200)])
        self.driver.back()
        self.driver.back()
    ...
    def random_download_theme(self):
        ...
        self.BF.random_click('id', 'com.emoji.ikeyboard:id/item')
        self.BF.click('id', 'com.emoji.ikeyboard:id/button_download')
        count_install = 0
        while True:
    ...
    def clear_download_theme(self):
        ...
        self.BF.click('id', 'com.emoji.ikeyboard:id/edit')
        while True:
            self.BF.click('id', 'com.emoji.ikeyboard:id/delete_button_action')
    ...
    def change_emoji_style(self, i):
        ...
        self.BF.click('id', 'com.emoji.ikeyboard:id/fab')
        self.BF.click('ides', 'com.emoji.ikeyboard:id/card_view[%s]' % i)

    def random_download_emoji_style(self):
        self.app_theme()
        self.BF.click('name', 'Emoji')
        self.BF.random_click('id', 'com.emoji.ikeyboard:id/card_view')
        self.BF.click('id', 'com.emoji.ikeyboard:id/button_download')
        count_install = 0
        while True:
            ex = self.BF.existence('id', 'com.android.vending:id/buy_button')
    ...
    def clear_download_emoji_style(self):
        ...
        self.BF.click('id', 'com.emoji.ikeyboard:id/edit')
        while True:
            self.BF.click('id', 'com.emoji.ikeyboard:id/button_action')
            self.BF.click('name', 'OK')
            time.sleep(8)
            if self.BF.existence('id', 'com.emoji.ikeyboard:id/button_action') is False:
                break
        print('下载emoji_style清理完毕')

    def cheage_font(self, i):
        self.app_theme()
        y = self.BF.check_find_element('id', 'com.emoji.ikeyboard:id/tab_layout').location["y"]
    ...
    def random_download_font(self):
        ...
        self.BF.click('name', 'Font')
        self.BF.random_click('id', 'com.emoji.ikeyboard:id/text_font_preview')
        self.BF.click('id', 'com.emoji.ikeyboard:id/button_download')
        count_install = 0
        while True:
    ...
    def clear_font(self):
        ...
        self.BF.click('id', 'com.emoji.ikeyboard:id/edit')
        while True:
            self.BF.click('id', 'com.emoji.ikeyboard:id/action_delete')
            time.sleep(8)
            if self.BF.existence('id', 'com.emoji.ikeyboard:id/action_delete') is False:
                break
        print('下载font清理完毕')
...
if __name__ == '__main__':
    ...
    #
    # IME = 'com.emoji.ikeyboard/com.android.inputmethod.latin.LatinIME'
