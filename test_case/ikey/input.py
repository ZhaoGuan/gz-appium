...
from golable_function.HTMLTestRunner_pic import HTMLTestRunner
...
class InputApp(unittest.TestCase):
    ...
    def setUp(self):
        ...
        time.sleep(5)
        self.BF.keyboard_select('com.emoji.ikeyboard/com.android.inputmethod.latin.LatinIME', self.device)
    ...
    def precast_condition(self):
        self.Ik.precast_condition('com.emoji.ikeyboard',
    ...
    def old_new_app1(self):
        self.Ik.old_new_app_custom_keyboard('com.emoji.ikeyboard',
                                            'com.emoji.ikeyboard/com.android.inputmethod.latin.LatinIME',
    ...
    def old_new_app2(self):
        ...
        for i in range(3, 12):
            # for i in range(5, 7):
            result = self.Ik.old_new_app_theme(i, 'com.emoji.ikeyboard',
                                               'com.emoji.ikeyboard/com.android.inputmethod.latin.LatinIME',
                                               '/Users/xm/Downloads/app-ikeyboard-135401-release-ikey_release.apk',
                                               '/Users/xm/Downloads/app-ikeyboard-135601-release-ikey_engine_refactor.apk')
    ...
    def old_new_app3(self):
        ...
        false_result = []
        for i in range(0, 5):
            result = self.Ik.old_new_app_font(i, 'com.emoji.ikeyboard',
                                              'com.emoji.ikeyboard/com.android.inputmethod.latin.LatinIME',
                                              '/Users/xm/Downloads/app-ikeyboard-135401-release-ikey_release.apk',
                                              '/Users/xm/Downloads/app-ikeyboard-135601-release-ikey_engine_refactor.apk')
            run_result.append(result)
    ...
    # pop_key检查
    def pop_key(self):
        top_y = self.BF.keyboard_get_ready('com.emoji.ikeyboard/com.android.inputmethod.latin.LatinIME',
                                           'class',
                                           'android.widget.ScrollView')
        keyboard = Keyboard_Operation(self.d, top_y)
    ...
    def keyboard_layout(self):
        default_top_y = self.BF.keyboard_get_ready('com.emoji.ikeyboard/com.android.inputmethod.latin.LatinIME',
                                                   'class',
                                                   'android.widget.ScrollView')
        # 开启数字和select
        self.Ik.app_settings()
        ...
        # 检查键盘是否高度变化
        self.d.start_activity('yuside.cn.numbersonly', 'yuside.cn.numbersonly.MainActivity')
        new_top_y = self.BF.keyboard_get_ready('com.emoji.ikeyboard/com.android.inputmethod.latin.LatinIME',
                                               'class',
                                               'android.widget.ScrollView')
    ...
    def test(self):
        top_y = self.BF.keyboard_get_ready('com.emoji.ikeyboard/com.android.inputmethod.latin.LatinIME', 'class',
                                           'android.widget.ScrollView', self.device)
...
if __name__ == "__main__":
    ...
    # suite.addTest(InputApp('download_theme'))
