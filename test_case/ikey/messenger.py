...
class Messenger(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.BF.keyboard_select('com.emoji.ikeyboard/com.android.inputmethod.latin.LatinIME')
        time.sleep(5)
    ...
    def en_input(self):
        top_y = self.M.select_user('com.emoji.ikeyboard/com.android.inputmethod.latin.LatinIME')
